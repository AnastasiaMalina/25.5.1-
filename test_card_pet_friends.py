...
def test_card_pet_friends():
    '''Проверка карточек питомцев'''

    # Устанавлмваем неявное ожидание
    ...
    assert pytest.driver.current_url == 'http://petfriends.skillfactory.ru/login'
    ...
    descriptions = pytest.driver.find_element_by_css_selector('.card-deck .card-text')
